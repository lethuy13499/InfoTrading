...
@Component
public class PriceSettingUpdateValidator implements InternalValidator {
    ...
    public InternalResult valid(Object domain) {
        ...
        Long id = priceSettingModel.getId();
        Timestamp updateTime = priceSettingModel.getUpdateTime();
        ...
        Long priceSettingDetailId = priceSettingDetailModel.getId();
        ...
        Timestamp priceSettingDetailUpdateTime = priceSettingDetailModel.getUpdateTime();
        Long priceSettingId = priceSettingDetailModel.getPriceSettingId();

        result.rejectIfEmptyOrWhitespace("id", priceSettingDetailId);
        ...
        result.rejectIfEmptyOrWhitespace("updateTime", priceSettingDetailUpdateTime);
        result.rejectIfEmptyOrWhitespace("priceSettingId", priceSettingId);
        ...
        for (CalculationDetailModel calculationDetailModel : calculationDetailModels) {
            ...
            Timestamp calculationDetailUpdateTime = calculationDetailModel.getUpdateTime();
            Long priceSettingDetailIdInCalculationDetail = calculationDetailModel.getPriceSettingDetailId();

            result.rejectIfEmptyOrWhitespace("id", priceSettingDetailIdInCalculationDetail);
            ...
            result.rejectIfEmptyOrWhitespace("updateTime", calculationDetailUpdateTime);
            result.rejectIfEmptyOrWhitespace("priceSettingDetailId", priceSettingDetailId);
